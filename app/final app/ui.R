...
shinyUI(navbarPage("Environment situation in NYC",theme="style.css",
...
tabPanel("General Intuition about water complaints",
         sidebarLayout(position="right",
                       sidebarPanel(
                         ...
                         selectInput("area_timeline","Select Plots:",
                                     choices = list( "None" = "",
                                                     ...
                                                     "Brooklyn"="Brooklyn",
                                                     "Queens"="Queens",
                                                     "Staten_island"="Staten_island"),selected = NULL,multiple = TRUE)
                       ),
                       ...
                       mainPanel(
                         tabsetPanel(type="pill",
                                     ...
                                     tabPanel("Basic Information about the total complaints",br(),tags$div(class="descrip_text",
                                                                                                           textOutput("line_text")),br(),
                                              
                                              
                                              plotOutput("totle_com_time"),value = 3)
                         ),
                         tabsetPanel(type="pill",
                                     
                                     tabPanel("More Specific Information",br(),tags$div(class="descrip_text",
                                                                                   textOutput("pies_text")),br(),
                                              
                                              
                                              plotOutput("piecharts"),value = 1),
                                     tabPanel("Graphs about seven water complaints",br(),tags$div(class="descrip_text",
                                                                                   textOutput("pie_text")),br(),
                                              plotOutput("piechart"),value = 2),
                                     
                                     tabPanel("Table about seven water complaints",br(),tags$div(class="descrip_text",
...
tabPanel("Word Cloud",
         ...
         sidebarLayout(
           ...
           sidebarPanel(
             ...
             sliderInput("freq",
                         "Minimum Frequency:",
                         min = 5000,  max = 107501, value = 10000),
             sliderInput("max",
