...
library(scales)
word_fre <- read.csv("311-request-frequency-2010_to_Present.csv", header=F)
...
total_compl<-t(total_com)
year <- c("2010","2011","2012","2013","2014","2015","2016")
data_1<-cbind(year,total_compl)
total_complaints <- as.data.frame(data_1)
myData_off <- melt(total_complaints,id.vars = "year")
